    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="glass p-6 rounded-2xl border border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <div className="glass px-4 py-2 rounded-xl border border-rose-500/20 text-center">
                  ...
                  <tr key={sub._id} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-4 text-right">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold mr-2"
                      >
                        Inspect Code
                      </button>
                      <button
                        onClick={() => handleOpenGradeModal(sub)}
                        className="px-3 py-1.5 rounded-lg bg-purple-500 hover:bg-purple-400 text-white text-xs font-semibold"
                      >
                        Grade
                      </button>
                    </td>
